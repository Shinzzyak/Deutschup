...
export default function QuickNoteWidget() {
  ...
  return (
    <>
      ...
      <div className={cn(
        "fixed bottom-28 right-6 w-[300px] h-[300px] bg-yellow-100 rounded-tr-3xl rounded-tl-3xl rounded-bl-3xl shadow-2xl flex flex-col z-50 transition-all duration-300 transform",
