        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button
                  ...
                  className="bg-[#0a0a0a] hover:bg-[#0a0a0a]/90 text-white text-base px-10 py-6 rounded-none font-bold tracking-wide transition-all group"
                >
                  Mulai Gratis
                ...
                <a
                  href="#roadmap"
                  className="inline-flex items-center justify-center gap-2 text-[#0a0a0a] hover:text-[#8b2500] font-semibold text-base px-10 py-6 border-2 border-[#0a0a0a] hover:border-[#8b2500] rounded-none transition-all"
                >
                  Lihat Kurikulum
                </a>
              </div>
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <div className="bg-white border-2 border-[#0a0a0a] p-6 sm:p-8">
                {/* Header */}
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#0a0a0a]/10">
                  ...
                  <div className="w-3 h-3 bg-[#2d8a4e] rounded-full" />
                </div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-[#0a0a0a] px-4 py-3 max-w-[85%] ml-auto">
                    <p className="text-sm text-white">Man sagt <span className="font-bold text-[#c8956c]">&quot;Danke&quot;</span></p>
                  </div>
                </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-[#8b2500] text-white px-6 py-4 shadow-lg"
              >
                <p className="text-2xl font-serif font-bold">1,600+</p>
                <p className="text-xs uppercase tracking-wider text-white/70">Kosakata</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
