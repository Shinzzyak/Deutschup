  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-foreground data-active:border-input data-active:bg-input/30 data-active:text-foreground",
