      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between" aria-label="Navigasi utama">
        <div className="flex items-center space-x-2">
          <div className="flex space-x-0.5">
            ...
            <div className="w-3 h-5 bg-indigo-600 rounded-sm"></div>
            <div className="w-3 h-5 bg-purple-500 rounded-sm"></div>
          </div>
          <span className="font-bold tracking-tight text-xl text-slate-900">DeutschUp</span>
        </div>
        <div className="flex items-center space-x-4">
          <a href="/login" className="text-slate-500 hover:text-slate-900 font-medium transition-colors text-sm" aria-label="Masuk ke akun Anda">
            Masuk
          </a>
          <Button onClick={loginWithGoogle} className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl text-sm px-5 py-2.5 shadow-md shadow-indigo-200/50">
            Daftar Gratis
          </Button>
        </div>
      </nav>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-2">
            <div className="flex space-x-0.5">
              ...
              <div className="w-2.5 h-4 bg-indigo-500 rounded-sm"></div>
