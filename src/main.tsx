...
buildTag.textContent = 'BUILD 2026-06-06-1702';
...
window.fetch = async function(...args) {
  ...
  if (url.includes('/api/')) {
    ...
    try {
      ...
      if (isHtml) {
        // Re-create response with text so downstream .json() doesn't crash
        // Actually we can't modify the original clone, but we logged it
      }
    } catch(e) {}
  }
  return resp;
