        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.4fr_0.9fr] lg:items-end">
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-2 text-xs font-black uppercase tracking-[0.12em] text-[#0a0a0a]/55">
              ...
              <span className="border border-[#0a0a0a]/10 bg-white/45 px-3 py-2">{currentLevelOverview.routeReadyCount} unit siap</span>
            </div>
          </div>
          ...
          <div className="hidden grid-cols-2 gap-3 sm:grid sm:grid-cols-4 lg:grid-cols-2">
            <div className="st-level-card p-4">
              ...
              <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#0a0a0a]/45">unit kurikulum</p>
            </div>
            <div className="st-level-card p-4">
              ...
              <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#0a0a0a]/45">pelajaran</p>
            </div>
            <div className="st-level-card p-4">
              ...
              <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#0a0a0a]/45">evaluasi</p>
            </div>
            <div className="st-level-card p-4">
          ...
          >
            ...
            <div className="mt-5 grid grid-cols-3 gap-2 text-center">
              <div className="bg-white/45 p-2">
                ...
                <p className="text-[10px] uppercase tracking-[0.12em] text-[#0a0a0a]/40">Pelajaran</p>
              </div>
              <div className="bg-white/45 p-2">
                <p className="text-sm font-black text-[#0a0a0a]">{level.checkpointCount}</p>
                <p className="text-[10px] uppercase tracking-[0.12em] text-[#0a0a0a]/40">Ujian</p>
              </div>
              <div className="bg-white/45 p-2">
                <p className="text-sm font-black text-[#0a0a0a]">{formatId.format(level.vocabularyCount)}</p>
                <p className="text-[10px] uppercase tracking-[0.12em] text-[#0a0a0a]/40">Kata</p>
              </div>
            </div>
      ...
      <section className="grid gap-5 lg:grid-cols-[1.25fr_0.75fr]">
        <div className="st-card p-5 sm:p-6">
          <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-[#0a0a0a]/45">Level saat ini</p>
        ...
        <aside className="border border-[#0a0a0a]/10 bg-primary p-5 sm:p-6 text-primary-foreground">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-primary-foreground/40">Latihan tambahan</p>
          ...
          <div className="space-y-3">
            ...
            <Link to="/goethe" className="flex items-center justify-between gap-3 border border-white/10 bg-white/5 p-3 text-sm font-bold hover:bg-white/10">
              <span className="inline-flex min-w-0 items-center gap-2 break-words"><Trophy className="h-4 w-4 shrink-0 text-[#c8956c]" />Persiapan Goethe</span>
              <ArrowRight className="h-4 w-4 shrink-0" />
            </Link>
          </div>
