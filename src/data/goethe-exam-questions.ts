...
export const examLevels = [
  { id: 'a1', name: 'Goethe A1', color: 'green', icon: 'Sprout', description: 'Start Deutsch - Grundkenntnisse' },
  { id: 'a2', name: 'Goethe A2', color: 'blue', icon: 'BookOpen', description: 'Grundlegende Kenntnisse' },
  { id: 'b1', name: 'Goethe B1', color: 'purple', icon: 'Library', description: 'Selbstständige Sprachverwendung' },
  { id: 'b2', name: 'Goethe B2', color: 'red', icon: 'GraduationCap', description: 'Fortgeschrittene Kenntnisse' },
];

export const examSections = [
  { id: 'reading', name: 'Leseverstehen', icon: 'ScrollText', description: 'Reading Comprehension' },
  { id: 'grammar', name: 'Grammatik', icon: 'PenLine', description: 'Grammar & Structure' },
  { id: 'vocab', name: 'Wortschatz', icon: 'MessageCircle', description: 'Vocabulary' },
];
