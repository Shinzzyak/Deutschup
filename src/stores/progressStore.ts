...
interface ProgressState extends ProgressData {
  ...
  submitCheckpoint: (userId: string, checkpointId: string, answers: number[]) => Promise<boolean>;
...
export const useProgressStore = create<ProgressState>((set, get) => ({
  ...
  submitCheckpoint: async (
    ...
    // Server-side grading (N4): send answers, never a score. The server
    // computes score from curriculum_checkpoint_questions.
