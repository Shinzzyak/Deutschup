 ...
 *
 * Buttons match the CURRENT OnboardingFlow (2026-08): welcome -> Mulai /
 * Lewati untuk sekarang; goal -> Persiapan ujian / Percakapan / Karier /
 * Perjalanan; ready -> Ganti tujuan / Mulai dari sini / Lihat semua materi.
 * There is no level picker anymore — level comes from the server.
 */
export async function skipOnboarding(page: Page) {
  ...
  await page.locator('button:has-text("Mulai dari sini")').click({ timeout: 5000 }).catch(() => {});
